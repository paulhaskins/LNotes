...
\underline{Multiplying Matrices with square blocks along the diagonal:}\\
\[
...
\]
   ...
   .\] 
   \[
    dim \left( \mathcal{N} \left( A - 2I \right)  \right) =1 \qquad 
\begin{aligned}
 \mathcal{N}_1 \qquad &\bullet\\[-0.35ex]
 & \; \big|\\[-0.35ex] 
\mathcal{N}_2 \qquad  &\bullet
\end{aligned}
\text{ 1 Jordan Chain}
   .\] 
...
\]
 ...
 {
 Suppose $ A$ is an $n \times n$  matrix, and $ \chi _a \left( x \right) = \text{ det } \left( A - x I \right) $ is the characteristic polynomial of $ A$. $ \chi _a \left( A \right) =0$.\\
...
\]
     ...
     Assume statement true for $ m-1$ and
     \[
