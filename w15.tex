...
i.e.  the sum is direct: $ V_1 \oplus V_2 = \mathbb{R} ^2$\\
 ...
 \ex{}{
  Similarly,  if $ U_n = span \left\{  \vec{ e_1} ,\ldots , \vec{ e_n}  \right\}$ , and $ U_m = span \left\{ \vec{ e_{n+1}}, \vec{ e_{n+2}}, \ldots , \vec{ e_{n+m}}    \right\} $, $ U_n, U_m \subseteq \mathbb{R} ^{n+m}$. Then 
	 \[
	 \mathbb{R} ^{n+m} = U_n \oplus U_m 
	 .\] 
 }
 
 \ex{}{
 Suppose $ \vec{ v_1} , \vec{ v_2} ,\ldots , \vec{ v_k}  \in V $ is a collection of non-zero vectors. Let 
 \[
...
\pf{Proof:}{
 Let $ \left\{ \vec{ b_1} , \vec{ b_2} , \ldots , \vec{ b_k}  \right\} $ be a basis for $ V_1 \cap  V_2 $. Extend this to a basis for $ V_1$ by adding vectors $ \left\{ \vec{ f_1} , \vec{ f_2} , \ldots , \vec{ f_{\ell}}\right\}$ and to a basis for $ V_2$ by adding $ \vec{ w_1} ,\ldots \vec{ w_m} $ so that 
		\[
